...
module.exports = Class.extend({
  ...
  checkDocco : function(callback) {
    which('docco', function(err) {
      if (err) {
        return callback('Error: docco-central requires docco'
          + ' to be in the path. Install it with "npm install -g docco".');
      }
      callback();
    });
  },
