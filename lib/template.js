...
function Template(rootDir, sourceFiles, readmeFile, title) {
...
_.extend(Template.prototype, {
  ...
  getReadme : function() {
    ...
    var file = this.readmeFile ? this.readmeFile : path.join(this.rootDir, 'README.md');
